        ...
        <div class="row">
          <div class="col-lg">
            <div class="p-5">
              ...
              <form method="post" action="<?= base_url('registrasi/index') ?>" class="user">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="masukan password" name="password_1">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?= base_url('auth/login') ?>">sudah punya aku? silahkan login</a>
              </div>
            </div>
          </div>
        </div>
